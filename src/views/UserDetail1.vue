<template>
  ...
  <div class="round">
	 <div class="title">
	   ...
	   <div class="title" v-for="(user, index) in users.slice(0,1)" :key="index">
	 ...
	 <div class="lanren">
	 	<div class="flip-3d">
	 	 	<figure>
	 	    	<img src="https://upload-images.jianshu.io/upload_images/2530782-2880b7a29c99d459.jpg" alt="">
	 	    	<figcaption>我的脾气赶走了很多人，但留下了最真的人。</figcaption>
	 		</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
	 	    	<img src="https://upload.jianshu.io/users/upload_avatars/14715425/e0668349-8c75-43db-8a9d-c388e5f00d0d.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/180/h/180" alt="">
	 	    	<figcaption>青春是一场大雨，即使感冒了，还盼望回头再淋它一次。</figcaption>
	 	  	</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
			<img src="https://upload.jianshu.io/users/upload_avatars/4287007/b7b9c810-069e-4385-aec7-1823e94ee43d.jpg?imageMogr2/auto-orient/strip|imageView2/1/w/180/h/180" alt="">
	 	    	
				<figcaption>仅仅活着是不够的，还需要有阳光自由和一点花的芬芳。</figcaption>
	 		</figure>
	 	</div>
	...
	export default {
		data() {
			return {
				...
				users: [],
				userInfo: {
				  avatar: 'https://upload-images.jianshu.io/upload_images/2530782-2880b7a29c99d459.jpg'
				}
