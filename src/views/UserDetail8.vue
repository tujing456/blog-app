<template>
  ...
  <div class="round">
	 <div class="title">
	   ...
	   <div class="title" v-for="(user, index) in users.slice(7,8)" :key="index">
	 ...
	 <div class="lanren">
	 	<div class="flip-3d">
	 	 	<figure>
	 	    	<img src="http://www.aspku.com/uploads/allimg/181224/1454262529-0.jpg" alt="">
	 	    	<figcaption>不论做什么事，相信你自己，别让别人的一句话将你击倒。</figcaption>
	 		</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
	 	    	<img src="https://inews.gtimg.com/newsapp_bt/0/8383293600/640" alt="">
	 	    	<figcaption>每一个矜持淡定的现在，都有一个很傻很天真的曾经。</figcaption>
	 	  	</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
			<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfMaMsfvEgW5b5cOkreYP-9yMySnv2jSH46bFHXe_payw6KfvAwg&s" alt="">
	 	    	
				<figcaption>勇敢不是不害怕，而是害怕的时候你还能坚持去做。</figcaption>
	 		</figure>
	 	</div>
	...
	export default {
		data() {
			return {
				...
				users: [],
				userInfo: {
				  avatar: 'http://scimg.jianbihuadq.com/allimg/1901/106-1Z1261216195H.jpg'
				}
