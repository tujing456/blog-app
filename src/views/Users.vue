<template>
	...
	<div class="header">
		...
		<div class="aa">
			<div class="box">
				<img src="../assets/img/016.jpg" >
			</div>
		 <div class="left">
			 
			<div class="left-img-1">
				<router-link to="/UserDetail1" class = "text"><img src="../assets/img/001.jpg"></router-link>
			...
			<div class="left-img-2">
				<router-link to="/UserDetail2" class = "text"><img src="../assets/img/002.jpg"></router-link>
			 </div>
			<div class="left-p-2">
				<p>一 Gleconan</p>
		...
		<div class="right">
			<div class="rignt-img-1">
				<router-link to="/UserDetail3" class = "text"><img src="../assets/img/003.jpg"></router-link>
			</div>
			<div class="right-p-1">
				<p>一 Infinite monkey</p>
			</div>
			<div class="right-img-2">
				<router-link to="/UserDetail4" class = "text"><img src="../assets/img/004.jpg"></router-link>
			</div>
			<div class="rignt-p-2">
				<p>一 Read far pregnant people</p>
			</div>
			<div class="output">
