<template>
  ...
  <div class="round">
	 <div class="title">
	   ...
	   <div class="title" v-for="(user, index) in users.slice(8,9)" :key="index">
	 ...
	 <div class="lanren">
	 	<div class="flip-3d">
	 	 	<figure>
	 	    	<img src="http://www.gx8899.com/uploads/allimg/190724/3-1ZH419434D56.jpg" alt="">
	 	    	<figcaption>我相信，梦里能到达的地方，总有一天，脚步也能到达。</figcaption>
	 		</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
	 	    	<img src="http://img.wxcha.com/file/201809/10/58ce844b44.jpg" alt="">
	 	    	<figcaption>短暂的狂欢，以为一生绵延。漫长的告别，是青春盛宴。</figcaption>
	 	  	</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
			<img src="http://pic.9ht.com/up/2018-4/2018041815534051376.jpg" alt="">
	 	    	
				<figcaption>有些人在你生命中只是昙花一现，而你却终身守候。</figcaption>
	 		</figure>
	 	</div>
	...
	export default {
		data() {
			return {
				...
				users: [],
				userInfo: {
				  avatar: 'https://www.rongshunew.com/uploads/allimg/c190807/15A15Q0960T0-15Z0.jpg'
				}
