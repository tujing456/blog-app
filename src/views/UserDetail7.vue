<template>
  ...
  <div class="round">
	 <div class="title">
	   ...
	   <div class="title" v-for="(user, index) in users.slice(6,7)" :key="index">
	 ...
	 <div class="lanren">
	 	<div class="flip-3d">
	 	 	<figure>
	 	    	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgZka22Im6yXZjaB58BsqK2EcDkqcGCFV08wu-BnzxXuY2xsjQ8w&s" alt="">
	 	    	<figcaption>绝望自有绝望的力量，就像希望也有希望的无能。</figcaption>
	 		</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
	 	    	<img src="http://scimg.jianbihuadq.com/touxiang/201907/20190715170130115.jpg" alt="">
	 	    	<figcaption>你不在，我也过得很好，可是这不代表你不重要。</figcaption>
	 	  	</figure>
	 	</div>
	 	<div class="flip-3d">
	 		<figure>
			<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSypAnsCi90haqWZJNdia6WDgp3xpqIaTN6_7yBQZcX8YJFV2tRhA&s" alt="">
	 	    	
				<figcaption>成功的反义词不是失败，而是什么都不去做。</figcaption>
	 		</figure>
	 	</div>
	...
	export default {
		data() {
			return {
				...
				users: [],
				userInfo: {
				  avatar: 'http://scimg.jianbihuadq.com/touxiang/201907/20190715170130115.jpg'
				}
